...
private fun PlantDescription(description: String) {
    ...
    // Displays hte TextView on the screen and updates with the HTML description when inflated
    // Updates to htmlDescription will make AndroidView recompse and update the text
    AndroidView(
        factory = { context ->
